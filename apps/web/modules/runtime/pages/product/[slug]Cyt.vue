<template>
  <NuxtLayout name="default" :breadcrumbs="breadcrumbs">
    <div class="max-w-[2000px] mx-auto mt-10 mb-5">
      <p class="text-xl">{{ breadcrumbs[1].name }}</p>
    </div>
    <NarrowContainer>
      <div class="w-full md:grid gap-x-6 grid-areas-product-page grid-cols-product-page">
        <section class="grid-in-left-top md:h-full xl:max-h-[900px]">
